...
public class Tentang_Aplikasi extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (transferan_nip == null){
			Toast.makeText(Tentang_Aplikasi.this, "NIP : Null", Toast.LENGTH_LONG).show();
		}else{
	...
	private void popUp() {
		...
		cancel.setOnClickListener(v -> {
            dialog.dismiss();
            Toast.makeText(Tentang_Aplikasi.this, "Batal Entry Kritik dan Saran", Toast.LENGTH_LONG).show();
        });
		...
		save.setOnClickListener(v -> {
            ...
            if (feedback.isEmpty()) {
                ...
                simpan_kritik(nippegawai, feedback, tglkritik);
            }
	...
	private final Runnable runnable = new Runnable() {
		...
		public void run() {
			...
			tglkritik = strdate_tgl + " " + strdate_jam;
