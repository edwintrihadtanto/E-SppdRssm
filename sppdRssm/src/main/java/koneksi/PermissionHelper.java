...
public class PermissionHelper {
    ...
    private void checkAndRequestPermissions(){//1. Call this to check permission. (Call this affected loop for check permission until user Approved it)
        ...
        if (RequestCode == REQUEST_PERMISSION) {
            ...
            if (grantResults.length > 0) {
                for (int i = 0; i < permissions.length; i++)
                    perms.put(Arrays.toString(permissions), grantResults.length);
                ...
                if ((perms.get(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED)
                    ...
                    //Toast.makeText(mActivity, "Permissions Granted", LENGTH_LONG).show();
                    checkAndRequestPermissions();
                } else {
                    Log.e(TAG, "Permissions Denied");
                    Toast.makeText(mActivity, "Permissions Denied", LENGTH_LONG).show();
...
//                                                    break;
                    ...
                    // shouldShowRequestPermissionRationale will return false
                        ...
                        Toast.makeText(mActivity, R.string.go_to_permissions_settings, LENGTH_LONG).show();
                        mActivity.finish();
